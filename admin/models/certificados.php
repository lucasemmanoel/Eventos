...
class P22eventosModelCertificados extends JModel
{
	...
	function &getRegistro()
	{
		...
		if ( empty( $this->_data ) )
		{
			$query = ' SELECT * FROM #__p22eventos_certificados'.
	...
	public function getTreatedEventName()
	{
		$model = &JModel::getInstance( 'avatar' , 'P22eventosModel' );

		return $model->remove_acentos( $this->getEventName() );
	}
}