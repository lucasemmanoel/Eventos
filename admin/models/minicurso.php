...
class P22eventosModelMinicurso extends JModel
{
	public $id;
	public $lib;
	public $idevento;
	...
	function delete()
	{
		...
		if (count( $cids ) )
		{
			foreach( $cids AS $cid )
			{
				if ( $grade[ $cid ] )
				{
					JError::raiseNotice( 100, 'O Mini-curso #ID ' . $cid . ' possui horários na grade vinculados a ele. Altere a grade de palestras e depois volte para excluí-lo.' );
					$return = false;
					continue;
				}
