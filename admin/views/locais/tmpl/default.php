...
?>
<style type="text/css">
	.icon-48-p22Locais{ background-image: url('components/com_p22evento/images/locais.png') }
</style>
<form action="index.php?option=com_p22evento&task=locais" method="post" name="adminForm">
	<div id="editcell">
		<table>
			<tr>
		...
		<table class="adminlist">
			<thead>
				<tr style="background-color: #f2f2f2;">
					...
					<th nowrap="nowrap" class="title" style="text-align:left">
						<?php echo JHTML::_('grid.sort',  'Nome', 'p.nome', @$this->lists[ 'order_Dir' ], @$this->lists[ 'order' ] , 'locais' ); ?>
					</th>
			...
			<tbody>
				...
				for ($i = 0, $n=count( $this->registros ); $i < $n; $i++)
				{
					...
					$link		= JRoute::_( 'index.php?option=com_p22evento&controller=local&task=edit&cid[]='. $row->id );
					?>
	...
	<input type="hidden" name="task" value="locais" />
