...
class P22eventosViewLocais extends JView
{
	function display( $tpl = null )
	{
		JToolBarHelper::title( JText::_( 'Locais' ) , 'p22Locais' );
		
		
		JToolBarHelper::publishList();
		JToolBarHelper::unpublishList();
		JToolBarHelper::deleteList( 'Tem certeza que deseja excluir este local?' );
		...
		$context = 'com_p22evento.locais.list.';
