...
class P22eventosViewSala extends JView
{
	function display( $tpl = null )
	{
		...
		JToolBarHelper::title(   JText::_( 'Sala' ).': <small><small>[ ' . $text.' ]</small></small>', 'p22Salas'  );
