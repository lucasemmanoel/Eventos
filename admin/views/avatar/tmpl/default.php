...
<?php if( $this->closeWindow ) : ?>
	window.parent.changeImgAvatar( '<?php echo JRequest::getVar('id'); ?>' , '<?php echo $this->image; ?>' );
...
$(window).load(function () {
	window.parent.changeImgAvatar( '<?php echo JRequest::getInt('id'); ?>' , '<?php echo $this->image; ?>' );
...
<div class="col100">
	<fieldset class="adminform">
		...
		<div id="campo_file">
			<form action="index3.php?option=com_p22evento&controller=palestrante&task=avatar&id=<?php echo JRequest::getInt('id'); ?>" name="adminForm" method="post" enctype="multipart/form-data">
				<table width="100%">
					<tr>
						<td>
				...
				<input type="hidden" name="id" value="<?php echo JRequest::getInt('id'); ?>" id="id" />
				<input type="hidden" name="idevento" value="<?php echo JRequest::getInt('idevento'); ?>" id="id" />
	...
	<fieldset class="adminform">
		...
		<div id="campo_imagem">
			...
			<div align="center">
				...
				<br style="clear:both;"/>
				<hr />
				<form action="index3.php?option=com_p22evento&controller=palestrante&task=avatar&id=<?php echo JRequest::getInt('id'); ?>" name="thumbnail" method="post">
					...
					<input type="hidden" name="id" value="<?php echo JRequest::getVar('id'); ?>" id="id" />
