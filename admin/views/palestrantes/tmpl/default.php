		...
		<table class="adminlist">
			<thead>
				<tr style="background-color: #f2f2f2;">
					...
					<th nowrap="nowrap" class="title" style="text-align:left">
						<?php echo JHTML::_('grid.sort',  'Palestrante', 'name', @$this->lists[ 'order_Dir' ], @$this->lists[ 'order' ] , $this->nome_plural ); ?>
					</th>
			...
			<tbody>
				...
				for ($i = 0, $n=count( $this->registros ); $i < $n; $i++)
				{
					...
					$link			= JRoute::_( 'index.php?option=com_p22evento&controller=palestrante&idevento='. intval( $this->idevento ) .'&task=edit&cid[]='. $row->id );
					...
					$avatar_img		= ( $seImgExists ) ? '../' . $row->avatar_img : 'components/com_p22evento/images/no_picture.jpg';
					?>
						...
						<td>
							<table width="100%">
								<tr>
									...
									<td>
										<?php echo ( $row->name ) ? '<a href="'. $link .'">'. $row->name . '</a>' : '<em>Usuário Inexistente</em>'; ?>
									</td>
								</tr>
								<tr>
									<td align="right">
